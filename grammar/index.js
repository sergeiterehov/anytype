...
var grammar = {
    ...
    {"name": "Type$string$11", "symbols": [{"literal":"s"}, {"literal":"e"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "Float", "symbols": ["Integer", {"literal":"."}, "UnsignedInteger"], "postprocess": (d) => parseFloat(d[0] + d[1] + d[2])},
    {"name": "Integer", "symbols": ["UnsignedInteger"], "postprocess": id},
    {"name": "Integer", "symbols": [/[\+\-]/, "UnsignedInteger"], "postprocess": (d) => d[0] === "-" ? 0 - d[1] : d[1]},
    ...
    {"name": "UnsignedInteger", "symbols": ["UnsignedInteger$ebnf$1"], "postprocess": (d) => Number(d[0].join(""))},
